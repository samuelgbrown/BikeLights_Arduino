...
const pb_field_t bluetooth_BluetoothMessage_BikeWheelAnim_fields[6] = {
    ...
    PB_FIELD(  2, MESSAGE , REPEATED, CALLBACK, OTHER, bluetooth_BluetoothMessage_BikeWheelAnim, palette, num_leds, &bluetooth_BluetoothMessage_BikeWheelAnim_Color__fields),
    PB_FIELD(  3, UINT32  , REPEATED, CALLBACK, OTHER, bluetooth_BluetoothMessage_BikeWheelAnim, image_main, palette, 0),
    PB_FIELD(  4, UINT32  , REPEATED, CALLBACK, OTHER, bluetooth_BluetoothMessage_BikeWheelAnim, image_idle, image_main, 0),
...
const pb_field_t bluetooth_BluetoothMessage_BikeWheelAnim_Color__fields[3] = {
    PB_FIELD(  1, MESSAGE , REPEATED, CALLBACK, FIRST, bluetooth_BluetoothMessage_BikeWheelAnim_Color_, color_objs, color_objs, &bluetooth_BluetoothMessage_BikeWheelAnim_Color__ColorObj_fields),
...
const pb_field_t bluetooth_BluetoothMessage_Kalman_fields[6] = {
    ...
    PB_FIELD(  4, FLOAT   , REPEATED, CALLBACK, OTHER, bluetooth_BluetoothMessage_Kalman, r, q, 0),
    PB_FIELD(  5, FLOAT   , REPEATED, CALLBACK, OTHER, bluetooth_BluetoothMessage_Kalman, p0, r, 0),
    PB_LAST_FIELD
};
